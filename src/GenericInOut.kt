...
// *****************
// * <IN T: SubBase> == Contravariant, restricted to specific subclasses/subtypes
...
// *********
// * <OUT R> == Covariant, can return any generic class/type, or Superclass/type of it
// 'out' must be a Supertype of generic param
...
// ******************
// * <OUT R: SubBase>
// <out R: onlyTypeOrSuperTypeOfR>
// 'out' must be a Supertype of generic param, restricted to class and superclass/type of SubBase
...
//                   Tt=to       Rt=to                      Tf=from  Rf=from
val w1: Crossvariant<SubBase,    SubBase>    = Crossvariant<Base,    Base>()          // Error, SubBase is minimum class
val w2: Crossvariant<SubBase,    SubBase>    = Crossvariant<Base,    SubBase>()       // OK
val w3: Crossvariant<SubBase,    Base>       = Crossvariant<Base,    SubBase>()       // Error, Rt Base not in bounds of R
val w4: Crossvariant<Base,       Base>       = Crossvariant<Base,    SubBase>()       // Error, Rt Base not in bounds of R
...
val e7: Crossvariant<SubBase,    SubBase>    = Crossvariant<SubBase, Base>()          // Error, R SubBase < R Base (out of bounds)
